...
A wealth of economic data can be extracted from the Federal Reserve Economic Data (FRED) database. It contains over 10K data sets that are free to use. See the FRED categories to narrow down the data base and to get data codes. https://fred.stlouisfed.org/categories
